            ...
            <form id="edit-about-form">
                ...
                <div class="form-group">
                    ...
                    <div id="about-image-box" style="border:2px dashed #ccc; border-radius:8px; padding:28px; text-align:center; cursor:pointer;">
                        <img id="about-image-preview" src="{{ asset($about->about_image) }}" alt="About Image"
                             style="max-height:80px; border-radius:6px; margin-bottom:10px;">
                        <div id="about-image-placeholder" style="display:none;">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="footprint_regions" value="{{ old('footprint_regions', $about->footprint_regions) }}" required>
                ...
                <div class="form-group">
                    ...
                    <textarea name="solutions_text" rows="3" required>{{ old('solutions_text', $about->solutions_text) }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea name="vision_text" rows="4" required>{{ old('vision_text', $about->vision_text) }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <div id="vision-image-box" style="border:2px dashed #ccc; border-radius:8px; padding:28px; text-align:center; cursor:pointer;">
                        <img id="vision-image-preview" src="{{ asset($about->vision_image) }}" alt="Vision Image"
                             style="max-height:80px; border-radius:6px; margin-bottom:10px;">
                        <div id="vision-image-placeholder" style="display:none;">
                            <p style="margin:0; color:#888; font-size:14px;">Click to select an image</p>
                            <span style="font-size:12px; color:#bbb;">JPG, PNG, WEBP — max 2MB</span>
                        </div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="commitment_title" value="{{ old('commitment_title', $about->commitment_title) }}" required>
                    <span class="error-text" id="error-commitment_title"></span>
                </div>
                <div class="form-group">
                    <label>Commitment Text</label>
                    <textarea name="commitment_text" rows="3" required>{{ old('commitment_text', $about->commitment_text) }}</textarea>
                ...
                <form id="add-value-form">
                    ...
                    <div class="form-group">
                        ...
                        <select name="card_type">
                            <option value="light-card">Light</option>
                            <option value="gold-card">Gold</option>
                        </select>
    ...
    $('#add-value-form').on('submit', function (e) {
        ...
        $.ajax({
            ...
            error: function (xhr) {
                btn.text('Add Value').prop('disabled', false);
                const errors = xhr.responseJSON?.errors;
                if (errors) $.each(errors, (field, messages) => $('#add-error-' + field).text(messages[0]));
            }
        });
    });
    ...
    $('#edit-value-form').on('submit', function (e) {
        ...
        $.ajax({
            ...
            error: function (xhr) {
                btn.text('Save Changes').prop('disabled', false);
                const errors = xhr.responseJSON?.errors;
                if (errors) $.each(errors, (field, messages) => $('#edit-error-' + field).text(messages[0]));
            }
        });
    });
